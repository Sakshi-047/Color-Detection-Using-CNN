...
## Results:
The CNN achieved validation accuracy of 99% across all 10 color categories. Testing on a new, unseen image confirmed that the trained CNN could accurately identify the dominant color based solely on pixel information. 
